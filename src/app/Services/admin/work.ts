...
export class AdminWork {
  ...
  GetDocId(token: string): Observable<any> {
    const headers = new HttpHeaders({
      Token: token, // Pass the token in the Authorization header
    });
  ...
  GetWorkByID(
    ...
    const params = new HttpParams()
      ...
      .set('userid', userId.toString())
      .set('jobid', jobId.toString());
    return this.httpClient.get<any>(this.apiUrl + 'Work/ReturnByID', {
      headers,
      params,
    });
  }
  ...
  GetWorkDoc(
    ...
    const params = new HttpParams()
      ...
      .set('DocTypeID', type);
    return this.httpClient.get<any>(
      this.apiUrl + 'Documents/WorkDocReturnByType',
      {
        headers,
        params,
      }
  ...
  CreateWorkDoc(
    ...
    return this.httpClient.post<any>(
      this.apiUrl + 'Documents/WorkDocCreate',
      workDetal,
      {
        headers,
      }
  ...
  UpdateWorkDoc(
    ...
    return this.httpClient.post<any>(
      this.apiUrl + 'Documents/WorkDocRejected',
      workDetal,
      {
        headers,
      }
